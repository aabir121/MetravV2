...
class SelectedPlaceFindBackground extends AsyncTask<String, Void, String> {
    ...
    public SelectedPlaceFindBackground(TextView textView,ProgressDialog progressDialog) {
